...
NOTE: The game commences directly after ball placement. The team receiving the ball may manipulate immediately and leave the opposing team little time to arrange defensive actions if needed.

NOTE: It is allowed to enter the defense area during ball placement.

Teams in Entry Level may decide, at any time before or during the game, not to place the ball for the rest of the game by talking to the <<Referee, referee>>, who in turn tells the <<Game Controller Operator, game controller operator>> to disable ball placement for this team.
...
When the <<Normal Start, normal start>> command is issued, the kicker is allowed to manipulate the ball. A goal may be scored directly from the kick-off.
